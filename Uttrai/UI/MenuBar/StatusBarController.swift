...
final class StatusBarController {
    ...
    func updateIcon(state: StatusBarIconState) {
        ...
        case .recording:
            setTintedIcon(symbolName: "waveform.circle.fill", color: NSColor.Uttrai.accent)
            startPulseTimer()
    ...
    private func setTemplateIcon(symbolName: String) {
        ...
        let image = NSImage(systemSymbolName: symbolName, accessibilityDescription: "Uttrai")
