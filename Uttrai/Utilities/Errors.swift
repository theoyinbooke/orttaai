...
enum UttraiError: LocalizedError {
    case modelNotLoaded
    case modelCorrupted
    ...
    var errorDescription: String? {
        ...
        case .intelMacDetected:
            return "Uttrai requires Apple Silicon"
        case .outOfMemory:
    ...
    var recoverySuggestion: String? {
        ...
        case .intelMacDetected:
            return "Uttrai requires a Mac with Apple Silicon (M1 or later)."
        case .outOfMemory:
        ...
        case .tapCreationFailed:
            return "Restart Uttrai to activate the hotkey."
        }
    }
}
